/*
  Косяк (Егор прости меня если сможешь)
  Если открыть сайдбар на мобилках,
  перейти на десктоп (сайдбар перестроиться),
  потом открыть модалку и закрыть на кнопку,
  то перекрывающий слой останется
*/
